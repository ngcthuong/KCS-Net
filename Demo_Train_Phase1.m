...
%%% Configuration
%%%-------------------------------------------------------------------------
opts.modelName        = ['KCSNet_Phase1_' num2str(noLayer) '_' num2str(featureSize) '_r' num2str(subRate) ...
...
opts.gpus             = [2]; %%% this code can only support one GPU!
